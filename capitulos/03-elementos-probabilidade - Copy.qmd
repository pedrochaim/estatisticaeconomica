---
title: "Elementos de Probabilidade"
format:
  revealjs:
    theme: simple
    css: styles.css
...
## Espaço de Probabilidades {.scrollable}
...
## Relações entre conjuntos {.scrollable}
...
::: {.callout-note title="Diferença entre $\subset$ e $\subseteq$" icon="false"}

Uma ressalva sobre notação.

:::

::: {.callout-note title="Paradoxo de Russell" icon="false"}
...
## Operações entre Conjuntos {.scrollable}
...
## Eventos Disjuntos e Partições {.scrollable}

::: {.callout-note title="Definição: Eventos disjuntos" icon="false"}
...
::: {.callout-note title="Definição: Partição de um conjunto" icon="false"}
...
## Espaço de Eventos {.scrollable}

::: {.callout-note title="Definição: Espaço de eventos" icon="false"}
...
## Função de Probabilidade {.scrollable}
...
## Probabilidade Condicional e Independência entre Eventos {.scrollable}

### Probabilidade condicional

::: {.callout-note title="Definição: Probabilidade condicional" icon="false"}
...
::: {.callout-note title="Lei da Probabilidade Total" icon="false"}
...
::: {.callout-note title="Teorema de Bayes" icon="false"}

Tome $A,A^c$ formando uma partição de $\Omega$ e $B$ um evento qualquer. Então
\begin{align*}
...
::: {.callout-note title="Solução" collapse="true"}
...
::: {.callout-note title="Definição: Independência entre dois eventos" icon="false"}
...
::: {.callout-note title="Definição: Independência entre uma coleção de eventos" icon="false"}
